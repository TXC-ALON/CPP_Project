...
namespace Utils
{
    ...
    void LOG::set_multi_sink(int console_level, int file_level)
    {
        ...
        std::string logFileName = Utils::LOG::get_log_name();
    ...
    void LOG::Turn_on_Log(int console_level, int file_level) { set_multi_sink(console_level, file_level); };
    void LOG::Turn_off_Log() { set_multi_sink(6, 6); };
